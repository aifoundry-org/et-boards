...
#
# Like DeviceProject but SOURCE_DIR is ${CMAKE_SOURCE_DIR}/${source_subpath}
# instead of ${CMAKE_SOURCE_DIR}/${name}. Useful when the directory name
# differs from the ExternalProject target name.
#
function(DeviceProjectFrom name source_subpath cmake_args)
    if(cmake_args)
        separate_arguments(args_list UNIX_COMMAND "${cmake_args}")
    endif()
    ...
    ExternalProject_Add(
        ${name}
        SOURCE_DIR ${CMAKE_SOURCE_DIR}/${PROJECT_BASE_DIR}/${source_subpath}
        DEPENDS ${ARGN}
        CMAKE_ARGS
                   -DCMAKE_BUILD_TYPE=Release
                   -DCMAKE_TOOLCHAIN_FILE=${ET_PLATFORM_PATH}/lib/cmake/riscv64-ec-toolchain.cmake
